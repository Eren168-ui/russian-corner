...
**Goal:** Make every Russian word in the 35 trial expressions clickable with local contextual analysis, add optional Yandex Dictionary/Wiktionary expansion, and make the floating card truly movable and persistent across all four screen corners.

**Architecture:** Keep the existing Core → Platform → UI → App dependency direction. Add a compact local word-analysis dictionary plus per-sentence token mappings to `TrialContentSlice`; resolve those into view-model values without adding basic words to the review queue. Local reviewed analysis is always primary; Yandex Dictionary is a Keychain-backed, failure-tolerant online supplement and Wiktionary is an explicit external fallback. Add pure nearest-corner geometry and persist the chosen corner after dragging; expose the same state through a header menu.
...
- [x] **Step 1: Write failing bundle coverage tests**
...
- [x] **Step 3: Add minimal models and tokenizer**
...
- [x] **Step 4: Add fail-closed catalog validation**
...
- [x] **Step 1: Add 97 reviewed local word entries**
...
- [x] **Step 2: Add all 137 contextual mappings**
...
- [x] **Step 3: Expand the shell gate**
...
- [x] **Step 4: Run data and catalog verification**
...
- [x] **Step 1: Write failing URL and attributed-token tests**
...
- [x] **Step 3: Implement interactive attributed text**
...
- [x] **Step 4: Implement selected-word details**
...
- [x] **Step 3: Implement geometry and drag persistence**
...
- [x] **Step 4: Add the header corner menu**
...
- [x] **Step 1: Document interaction and privacy**
...
- [x] **Step 3: Perform application-level interaction verification**
...
- [x] **Step 4: Write the requirement matrix**
