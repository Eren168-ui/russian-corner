...
Russian Corner 保留审核后的 360 个词汇记录和 72 个派生句子卡，默认按“A2 已完成、正在冲 B1”筛选新词。首轮 7 天试用不会投放全库，而是使用独立白名单：35 张完整表达卡和 15 张由表达支撑的词汇卡，覆盖 6 个高频生活场景。35 句中的每个俄语词都可点击，97 个审核词条覆盖全部 137 个词位，并按需展示重音、词形、体对、支配、搭配和本句用法。应用提供可吸附四角的桌面卡、8 个全局快捷键、俄语朗读、间隔复习、本地提醒、每日反馈、学习诊断和用户可读的 7 天 Markdown 报告。支持 macOS 14 及以上版本。
